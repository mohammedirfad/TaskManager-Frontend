...
function Home() {
  ...
  const deleteTodo = async (id) => {
    try {
      ...
      setTodos((todos) =>
        todos.filter((todo) => todo._id !== response?.data?.tasks?._id)
      );
    } catch (error) {
      console.error("Error:", error);
    }
        ...
        <div className="todos">
          <div className="todo-container">
            ...
            {todos.length > 0 ? (
              ...
              <div className="">
                <p className="display">
                  Hey ! <span className="name">{Name}</span> You currently have
                  no tasks todo ...
                </p>
                <p className="img-display">
                  <img
